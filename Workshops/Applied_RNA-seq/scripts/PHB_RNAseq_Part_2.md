---
title: "PHB RNA-seq Workshop: Part 2" 
...
![](PHB_RNAseq_Part_2_files/figure-html/pca-1.png)<!-- -->
...
![](PHB_RNAseq_Part_2_files/figure-html/pca-2.png)<!-- -->
...
![](PHB_RNAseq_Part_2_files/figure-html/pca-3.png)<!-- -->
...
![](PHB_RNAseq_Part_2_files/figure-html/pca-4.png)<!-- -->
...
![](PHB_RNAseq_Part_2_files/figure-html/PCA-correaltion-1.png)<!-- -->
...
![](PHB_RNAseq_Part_2_files/figure-html/PCA-correaltion-2.png)<!-- -->
...
![](PHB_RNAseq_Part_2_files/figure-html/pca-plots-1.png)<!-- -->
...
![](PHB_RNAseq_Part_2_files/figure-html/pca-plots-2.png)<!-- -->
...
![](PHB_RNAseq_Part_2_files/figure-html/pca-plots-3.png)<!-- -->
...
![](PHB_RNAseq_Part_2_files/figure-html/pca-plots-4.png)<!-- -->
...
mDat %>% 
  ...
  labs( x = "Principle Component 2", y = "Principle Component 3", title = "Ventilator Free Days : PC1 vs PC2") +
  #scale_colour_manual(values = c("grey", "purple")) +
  theme_minimal()
```

![](PHB_RNAseq_Part_2_files/figure-html/pca-plots-5.png)<!-- -->
...
mDat %>% 
  ...
  geom_point(size = 3) +
  coord_cartesian(ylim = c(-100, 100), xlim = c(-100, 100)) +
  labs( x = "Principle Component 2", y = "Principle Component 3", title = "ICU: PC1 vs PC2") +
  scale_colour_manual(values = c("grey", "blue")) +
  theme_minimal() 
```

![](PHB_RNAseq_Part_2_files/figure-html/pca-plots-6.png)<!-- -->
...
![](PHB_RNAseq_Part_2_files/figure-html/DE-covid-age-lactate-1.png)<!-- -->
...
![](PHB_RNAseq_Part_2_files/figure-html/DE-covid-age-lactate-2.png)<!-- -->

Given that we saw that the S100A9 gene showed the highest negative logFC in our first model, let's compare the expression of S100A9 between COVID positive and negative patients.  
...
![](PHB_RNAseq_Part_2_files/figure-html/S100A9-1.png)<!-- -->
...
![](PHB_RNAseq_Part_2_files/figure-html/GBGT1-HBA2-1.png)<!-- -->
...
![](PHB_RNAseq_Part_2_files/figure-html/timepoint-makecontrasts-1.png)<!-- -->
...
# mart <- readRDS(here::here("data", "hs_mart.rds"))
...
# hgnc_to_entrez <- readRDS(here::here("data", "hgnc_to_entrez.rds"))
...
# go_terms <- readRDS(here::here("data", "go_terms.rds"))
...
## 1       ABTB1                           
## 2       ABTB1 GO:0005737       cytoplasm
## 3       ABTB1 GO:0006412     translation
## 4       ABTB1 GO:0005730       nucleolus
## 5       ABTB1 GO:0005829         cytosol
## 6       ABTB1 GO:0005886 plasma membrane
##                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        definition_1006
## 1                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     
## 2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        The contents of a cell excluding the plasma membrane and nucleus, but including other subcellular structures.
## 3                                                                                                              The cellular metabolic process in which a protein is formed, using the sequence of a mature mRNA or circRNA molecule to specify the sequence of amino acids in a polypeptide chain. Translation is mediated by the ribosome, and begins with the formation of a ternary complex between aminoacylated initiator methionine tRNA, GTP, and initiation factor 2, which subsequently associates with the small subunit of the ribosome and an mRNA or circRNA. Translation ends with the release of a polypeptide chain from the ribosome.
## 4 A small, dense body one or more of which are present in the nucleus of eukaryotic cells. It is rich in RNA and protein, is not bounded by a limiting membrane, and is not seen during mitosis. Its prime function is the transcription of the nucleolar DNA into 45S ribosomal-precursor RNA, the processing of this RNA into 5.8S, 18S, and 28S components of ribosomal RNA, and the association of these components with 5S RNA and proteins synthesized outside the nucleolus. This association results in the formation of ribonucleoprotein precursors; these pass into the cytoplasm and mature into the 40S and 60S subunits of the ribosome.
## 5                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               The part of the cytoplasm that does not contain organelles but which does contain other particulate matter, such as protein complexes.
...
```
##               name_1006   n
## 1       protein binding 170
## 2               cytosol 141
## 3             cytoplasm 139
## 4              membrane 137
## 5               nucleus  91
## 6 extracellular exosome  90
```
...
## 1       protein binding 170   200 85.0
## 2               cytosol 141   200 70.5
## 3             cytoplasm 139   200 69.5
## 4              membrane 137   200 68.5
## 5               nucleus  91   200 45.5
## 6 extracellular exosome  90   200 45.0
```
...
![](PHB_RNAseq_Part_2_files/figure-html/GO-enrichment-1.png)<!-- -->
...
![](PHB_RNAseq_Part_2_files/figure-html/GO-enrichment-2.png)<!-- -->
...
## 1       cytoplasm cellular_component
## 2     translation biological_process
## 3       nucleolus cellular_component
## 4         cytosol cellular_component
## 5 plasma membrane cellular_component
## 6 protein binding molecular_function
```
...
## 1       protein binding 170   200 85.0 molecular_function
## 2               cytosol 141   200 70.5 cellular_component
## 3             cytoplasm 139   200 69.5 cellular_component
## 4              membrane 137   200 68.5 cellular_component
## 5               nucleus  91   200 45.5 cellular_component
## 6 extracellular exosome  90   200 45.0 cellular_component
```
...
![](PHB_RNAseq_Part_2_files/figure-html/GOplot-1.png)<!-- -->
...
```r
kegg <- enrichKEGG(gene = hgnc_to_entrez$entrezgene_id, organism = "hsa")
```
...
```r
# kegg <- readRDS(here::here("data", "kegg_res.rds"))
...
```{=html}
<div id="htmlwidget-d185ea9022025bf83be5" style="width:100%;height:auto;" class="datatables html-widget"></div>
<script type="application/json" data-for="htmlwidget-d185ea9022025bf83be5">{"x":{"filter":"none","vertical":false,"data":[["hsa03010","hsa05171","hsa05140","hsa04145","hsa04380"],["hsa03010","hsa05171","hsa05140","hsa04145","hsa04380"],["Ribosome","Coronavirus disease - COVID-19","Leishmaniasis","Phagosome","Osteoclast differentiation"],["71/150","77/150","10/150","13/150","10/150"],["158/8159","232/8159","77/8159","152/8159","128/8159"],[7.22010038270739e-87,1.71735309895873e-82,1.24852711320428e-06,3.96605971358009e-06,0.000116009695249561],[1.22019696467755e-84,1.45116336862012e-80,7.03336940438412e-05,0.000167566022898759,0.00392112769943517],[1.09441521590512e-84,1.3015728750003e-80,6.30834751934794e-05,0.000150292789146193,0.00351692549809196],["","","1535/1915/2214/2215/3122/3123/3689/653361/6772/7097","60/71/11151/1535/2214/2215/3122/3123/3689/653361/6890/7097/7846","1535/2214/2215/353514/11025/102725035/653361/6688/6772/7305"],[71,77,10,13,10]],"container":"<table class=\"display\">\n  <thead>\n    <tr>\n      <th> <\/th>\n      <th>ID<\/th>\n      <th>Description<\/th>\n      <th>GeneRatio<\/th>\n      <th>BgRatio<\/th>\n      <th>pvalue<\/th>\n      <th>p.adjust<\/th>\n      <th>qvalue<\/th>\n      <th>geneID<\/th>\n      <th>Count<\/th>\n    <\/tr>\n  <\/thead>\n<\/table>","options":{"columnDefs":[{"className":"dt-right","targets":[5,6,7,9]},{"orderable":false,"targets":0}],"order":[],"autoWidth":false,"orderClasses":false}},"evals":[],"jsHooks":[]}</script>
```
