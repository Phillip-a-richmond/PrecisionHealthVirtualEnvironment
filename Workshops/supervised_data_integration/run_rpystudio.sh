...
#PBS -N supervised_data_integration
#PBS -A st-alloc-1
#PBS -m abe
...
Rstudio_SIF=/scratch/tr-precisionhealth-1/Workshops/StudentSpaces/$USER/supervised_data_integration/rpystudio.sif
Home_Dir=/scratch/tr-precisionhealth-1/Workshops/StudentSpaces/$USER/supervised_data_integration/
Data_Dir=/scratch/tr-precisionhealth-1/Workshops/StudentSpaces/$USER/supervised_data_integration/
Lib_Dir=/scratch/tr-precisionhealth-1/Workshops/StudentSpaces/$USER/supervised_data_integration/R_Libs_4.1.0/
