...
mkdir -p /scratch/tr-precisionhealth-1/Workshops/scRNAseq/
cd /scratch/tr-precisionhealth-1/Workshops/scRNAseq/

# Make an R_Lib directory there that matches the R version. To find the R version read up on the docker tag (link below)
mkdir -p /scratch/tr-precisionhealth-1/Workshops/scRNAseq/R_Libs_4.2.0/
