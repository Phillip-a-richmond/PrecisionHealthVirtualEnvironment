...
WorkingDir=/scratch/tr-precisionhealth-1/Workshops/Practical/$USER/Core_Practical/
Sample=Proband
...
FastqR1=${FastqDir}/${Sample}_R1.fastq.gz
FastqR2=${FastqDir}/${Sample}_R2.fastq.gz
