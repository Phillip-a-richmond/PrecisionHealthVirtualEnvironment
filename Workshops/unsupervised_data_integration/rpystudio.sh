...
#PBS -l walltime=03:00:00,select=1:ncpus=2:mem=64gb
#PBS -N rpystudio
#PBS -A st-singha53-1
#PBS -m abe
#PBS -M amrit.singh@hli.ubc.ca
#PBS -e error.txt
#PBS -o output.txt
...
Rstudio_SIF=/scratch/tr-precisionhealth-1/Workshops/StudentSpaces/$USER/unsupervised_data_integration/rpystudio.sif
Home_Dir=/scratch/tr-precisionhealth-1/Workshops/StudentSpaces/$USER/unsupervised_data_integration/
Data_Dir=/scratch/tr-precisionhealth-1/Workshops/StudentSpaces/$USER/unsupervised_data_integration/
Lib_Dir=/scratch/tr-precisionhealth-1/Workshops/StudentSpaces/$USER/unsupervised_data_integration/R_Libs_4.1.0/
