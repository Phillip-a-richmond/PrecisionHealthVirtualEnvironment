...
date: 'July 26, 2022 | 12:00-13:30<br><br>`r fontawesome::fa("link")` [lab](https://cbl-hli.github.io/) (I am hiring!)<br>`r fontawesome::fa("github")` [workshop material](https://github.com/Phillip-a-richmond/PrecisionHealthVirtualEnvironment/tree/main/Workshops/github)<br>`r fontawesome::fa("twitter")` [asingh_22g](https://twitter.com/asingh_22g)'
output: 
...
## [Why are you attending this workshop? https://www.slido.com/ - 1140678 ](https://app.sli.do/event/qHi6stRxK5D5W5LQTY762W/embed/polls/523cc387-8543-4f20-a1a6-0f70adb8d792)

.center[<img src ="img/slido_qr.png" alt="Slido_q1", width="50%"/>]
...
## [How is the pace of this workshop? https://www.slido.com/ - 1140678 ](https://app.sli.do/event/qHi6stRxK5D5W5LQTY762W/embed/polls/523cc387-8543-4f20-a1a6-0f70adb8d792)

.center[<img src ="img/slido_qr.png" alt="Slido_q1", width="40%"/>]
...
July 26, 2022 | 12:00-13:30<br><br>`r fontawesome::fa("link")` [lab](https://cbl-hli.github.io/) (I am hiring!)<br>`r fontawesome::fa("github")` [workshop material](https://github.com/Phillip-a-richmond/PrecisionHealthVirtualEnvironment/tree/main/Workshops/github)<br>`r fontawesome::fa("twitter")` [asingh_22g](https://twitter.com/asingh_22g)